...
from logical_teach import TChatClass
from logical_teach import TChatControlClass
from logical_teach import TContestClass
from logical_teach import TCoursewareClass
from logical_teach import TJoinRoom
from logical_teach import TLeaveClass
from logical_teach import TNoticeClass
from logical_teach import TReadSentenceClass
from logical_teach import TRewardClass
from logical_teach import TUserListClass
from logical_teach import TVoiceReadClass
from logical_teach import TVoteClass
import struct
import gzip
import threading
...
class Teacher(object):
    def __init__(self, liveId, userId, user_type, nickName, roomIndex, msn_ip):
        ...
        #         self.sock.getpeername()
        #         print("连接成功", self.sock.getpeername())
        #         readThread = threading.Thread(target=self.readSockData, args=(self.event,), name='Thread-read')
        #         readThread.start()
        #     else:
    ...
    def do_join(self):
        try:
            ...
            # heartThread = threading.Thread(target=self.heartLink, args=(), name='Thread-heart')
            # heartThread.start()
        except Exception as err:
            print(err)
...
if __name__ == '__main__':
    ...
    # 创建老师对象
    teacher_a = Teacher(liveID, tea_UID, user_type, nickname, roomID)
    ...
    try:
        ...
        #
        teacher_a.do_vote(logical_pb2.SIGNLE_RIGHT_MULTIPLE_CHOICE)
        # time.sleep(1)
